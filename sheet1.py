...
def method1():
    ...
    df = pd.read_excel("Project_1.xlsx", sheet_name="Sheet1", index_col=0)
    ...
    df.to_sql("Sheet1Table", con=engine, if_exists='replace', index=False)
    ...
    cursor.execute('SELECT * FROM Sheet1Table')
